...
export class UsersAddComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.allDivisiones =this.divisiones.getAll();
    // this.allDivisiones.
  ...
  addUser(event: Event, form: HTMLFormElement) {
    ...
    if (form.checkValidity()) {
      ...
      this.users.add({
        ...
        phone: this.phone,
        email: this.email,
        divisiones: [{ "idDivision": this.divisionSelected, "titleDivision": form.getElementsByClassName("custom-select")["division"].innerText}],

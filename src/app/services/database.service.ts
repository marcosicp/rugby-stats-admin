...
export class DatabaseService {
   ...
   * @param data
   */
  updateDocumentProperty(collectionPath: string, documentPath: string, propertyValue: any): Promise<void|any> {
    return this.afterUserRoleCheck(() => this.db.collection(collectionPath).doc(documentPath).update({tiempoJuego: propertyValue}));
  }
